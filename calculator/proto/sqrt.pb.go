...
var file_calculator_proto_sqrt_proto_rawDesc = []byte{
	...
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x75, 0x64, 0x64, 0x79, 0x56, 0x2f, 0x67, 0x72,
...
func file_calculator_proto_sqrt_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_calculator_proto_sqrt_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_calculator_proto_sqrt_proto_msgTypes[1].Exporter = func(v any, i int) any {
